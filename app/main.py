...
from app.api.engineers import engineers
...
app = FastAPI(openapi_url="/api/v1/engineers/openapi.json", docs_url="/api/v1/engineers/docs")


KEYCLOAK_URL = "http://keycloak:8080/"
KEYCLOAK_CLIENT_ID = "testClient"
KEYCLOAK_REALM = "testRealm"
KEYCLOAK_CLIENT_SECRET = "4hYopHOYQL0VOwwmYN2NFUcZgpiTbR0B"
...
app.include_router(engineers, prefix='/api/v1/engineers', tags=['engineers'])